...
def recon_output(for_ring, options=None, swift_recon_path="/usr/local/bin"):
    ...
    command = [os.path.join(swift_recon_path, 'swift-recon'), for_ring]
...
def swift_replication(for_ring, swift_recon_path="/usr/local/bin"):
...
def swift_async(swift_recon_path="/usr/local/bin"):
...
def swift_quarantine(swift_recon_path="/usr/local/bin"):
...
def swift_md5(swift_recon_path="/usr/local/bin"):
...
def swift_time(swift_recon_path="/usr/local/bin"):
